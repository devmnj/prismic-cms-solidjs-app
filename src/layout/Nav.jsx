...
import {setSearch, search} from "../stores/index"
        ...
        <div class="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
          <div class="lg:flex lg:items-center">
            ...
            <div class="flex flex-col text-gray-600 capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
              ...
              <div class="relative mt-1 lg:mt-0 lg:mx-4">
                <input
                  class="w-full m-2 rounded-md text-lg  border-2 border-gray-200"
                  type="text"
                  placeholder="Search Post"
                  onInput={(e)=>setSearch("keyWord",e.currentTarget.value)}
                />
                {/* Search component  */}
                {/*<Search />*/}
              </div>
